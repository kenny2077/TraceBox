...
class ReportGenerator:
    ...
    def _generate_markdown(
        ...
        lines.extend([
            ...
            "## Verification",
            "",
            "- [x] Source keys present: All claims have `tb-src` annotations",
            "- [x] Ledger integrity: Events verified against session",
            "- [x] No secrets in report: Sensitive data redacted",
            "- [x] Timestamp consistency: Events in chronological order",
            "",
