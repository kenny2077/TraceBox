...
def test_redact_aws_keys():
    ...
    # Test Access Key ID — use a realistic 20-char uppercase key
...
def test_redact_json_objects():
    ...
    data = {
        "status": "success",
        "api_key": "sk-123...cdef", # Key match
        "message": "Here is a token: AKIAIO...MPLE" # Value match
    }
    ...
    assert "AKIAIO...MPLE" not in redacted["message"]
